...
export async function buildVehicleDashboard({ vin, askingPrice = null, mileage = null, listingUrl = '', condition = 'good' }) {
  ...
  return {
    ...
    gating: {
      ...
      paid: ['ownershipTimeline', 'registrationTimeline', 'titleHistory', 'accidentDamageHistory', 'insuranceClaims', 'damagePhotoEvidence', 'odometerTimeline', 'serviceHistory', 'marketComps', 'pricingContext', 'buyerRecommendation', 'safetyRatings', 'reviewsSummary'],
      providerDependent: ['ownershipTimeline', 'registrationTimeline', 'titleHistory', 'accidentDamageHistory', 'insuranceClaims', 'damagePhotoEvidence', 'odometerTimeline', 'serviceHistory', 'listingEvidence', 'marketComps', 'safetyRatings', 'reviewsSummary']
    }
  };
}
