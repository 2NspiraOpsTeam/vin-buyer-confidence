...
export async function buildVehicleDashboard({ vin, askingPrice = null, mileage = null, listingUrl = '' }) {
  ...
  return {
    ...
    gating: {
      ...
      paid: ['ownershipTimeline', 'registrationTimeline', 'titleHistory', 'accidentDamageHistory', 'odometerTimeline', 'serviceHistory', 'marketComps', 'pricingContext', 'buyerRecommendation'],
      providerDependent: ['ownershipTimeline', 'registrationTimeline', 'titleHistory', 'accidentDamageHistory', 'odometerTimeline', 'serviceHistory', 'listingEvidence', 'marketComps']
    }
  };
}
